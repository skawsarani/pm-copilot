...
❌ Too much detail (save for opportunities/initiatives)
...
**Output** (AI creates `knowledge/opportunities/enterprise-sso.md`):
```markdown
# Opportunity: Enterprise SSO
...
## Strategic Context
- Acme Corp needs SAML SSO for 500 users ($500K ARR deal blocker)
- This is a common blocker for enterprise deals
- Competitors offer this as standard
- Could enable 3+ enterprise deals in Q1
...
## Initial Thoughts
- SAML SSO with Okta, Azure AD support
- User provisioning (SCIM)
- Just-in-time provisioning
- SSO + RBAC together

## Next Steps
- Validate with Acme if just SSO is sufficient or need RBAC
- Check if other deals are waiting on this
- Determine pricing model for enterprise tier
```
