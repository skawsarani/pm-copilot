...
description: Build working code prototypes from PRDs, product briefs, or user stories using React, TypeScript, and Shadcn/ui. Use when asked to create prototypes, validate concepts with code, build functional demos, or generate working implementations from product requirements. Triggers include "create prototype," "build prototype from [spec]," "prototype [feature]," "validate with code," or when the user provides a PRD/brief and wants a functional implementation.
---
